      ...
      child: Column(
        children: [
            ...
            child: ListView(
              ...
              children: [
                ...
                _Card(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  const Text('Free home sample collection', style: TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                ])),
                const SizedBox(height: 14),
                _Card(child: Column(children: [
                  _Row('Item total', '₹${app.cartMrpTotal}'),
                  _Row('Discount', '-₹${app.cartSavings}', color: AppColors.success),
                  _Row('Home collection fee', 'Free', color: AppColors.success),
                  const Divider(height: 20, color: AppColors.border),
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('To pay', style: AppTextStyles.bodyBold.copyWith(fontSize: 14)),
                    Text('₹${app.cartTotal}', style: AppTextStyles.h2.copyWith(fontSize: 17)),
                  ]),
                ])),
          ...
          Container(
            ...
            child: AppButton(label: 'Proceed to Pay · ₹${app.cartTotal}', onPressed: () => app.go('payment')),
          ),
        ],
      ),
    );
