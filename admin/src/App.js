...
// Mock Seed Data
const initialTests = [
  { id: 'cbc', name: 'CBC (Complete Blood Count)', short: 'Complete Blood Count', desc: 'Measures red cells, white cells & platelets to detect infections, anemia and blood disorders.', price: 299, mrp: 399, fasting: false, sample: 'Blood', report: '6 hrs', prep: 'No special preparation needed.', image: 'assets/cbc.jpg', isPackage: false },
  { id: 'sugar', name: 'Blood Sugar (Fasting / PP / HbA1c)', short: 'Blood Sugar', desc: 'Tracks fasting & post-meal glucose plus 3-month average sugar control (HbA1c).', price: 499, mrp: 650, fasting: true, sample: 'Blood', report: '6 hrs', prep: '8-10 hours fasting required before the test.', image: 'assets/sugar.jpg', isPackage: false },
  { id: 'thyroid', name: 'Thyroid Test', short: 'Thyroid Test', desc: 'Assesses thyroid gland function and hormone balance.', price: 599, mrp: 799, fasting: false, sample: 'Blood', report: '24 hrs', prep: 'No special preparation needed.', image: 'assets/thyroid.jpg', isPackage: false },
  { id: 'lipid', name: 'Lipid Profile', short: 'Lipid Profile', desc: 'Checks total cholesterol, HDL, LDL & triglycerides for heart health.', price: 649, mrp: 849, fasting: true, sample: 'Blood', report: '24 hrs', prep: '10-12 hours fasting required before the test.', image: 'assets/lipid.jpg', isPackage: false },
  { id: 'lft_kft', name: 'Liver & Kidney Test', short: 'Liver & Kidney Test', desc: 'Evaluates liver enzymes and kidney filtration markers together.', price: 899, mrp: 1199, fasting: true, sample: 'Blood', report: '24 hrs', prep: '8 hours fasting recommended.', image: 'assets/liver_kidney.jpg', isPackage: false },
  { id: 'urine', name: 'Urine Test', short: 'Urine Test', desc: 'Screens for infections, kidney issues & diabetes markers in urine.', price: 199, mrp: 249, fasting: false, sample: 'Urine', report: '6 hrs', prep: 'Collect the first morning sample if possible.', image: 'assets/urine.jpg', isPackage: false },
  { id: 'fever', name: 'Fever Tests (Dengue, Typhoid, Malaria)', short: 'Fever Tests', desc: 'Detects the most common fever-causing infections in one panel.', price: 1299, mrp: 1699, fasting: false, sample: 'Blood', report: '24 hrs', prep: 'No special preparation needed.', image: 'assets/fever.jpg', isPackage: false },
  { id: 'fullbody', name: 'Full Body Checkup', short: 'Full Body Checkup', desc: 'All 7 essential tests in one package - a complete health snapshot.', price: 2999, mrp: 5294, fasting: true, sample: 'Blood + Urine', report: '24 hrs', prep: '10-12 hours fasting required.', isPackage: true, includedTestIds: ['cbc', 'sugar', 'thyroid', 'lipid', 'lft_kft', 'urine', 'fever'] },
  { id: 'diabetes', name: 'Diabetes Care Package', short: 'Diabetes Care', desc: 'Sugar, Thyroid & Lipid - ideal for ongoing diabetes monitoring.', price: 1499, mrp: 1948, fasting: true, sample: 'Blood', report: '24 hrs', prep: '8-10 hours fasting required.', isPackage: true, includedTestIds: ['sugar', 'thyroid', 'lipid'] }
];
