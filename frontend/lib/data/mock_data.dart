...
class MockData {
  static const List<BloodTest> tests = [
    BloodTest(
      ...
      price: 299, mrp: 399, fasting: false, sample: 'Blood', report: '6 hrs',
    ...
    BloodTest(
      ...
      price: 499, mrp: 650, fasting: true, sample: 'Blood', report: '6 hrs',
    ...
    BloodTest(
      ...
      price: 599, mrp: 799, fasting: false, sample: 'Blood', report: '24 hrs',
      prep: 'No special preparation needed.',
    ...
    BloodTest(
      ...
      price: 649, mrp: 849, fasting: true, sample: 'Blood', report: '24 hrs',
    ...
    BloodTest(
      ...
      price: 899, mrp: 1199, fasting: true, sample: 'Blood', report: '24 hrs',
    ...
    BloodTest(
      ...
      price: 199, mrp: 249, fasting: false, sample: 'Urine', report: '6 hrs',
    ...
    BloodTest(
      ...
      price: 1299, mrp: 1699, fasting: false, sample: 'Blood', report: '24 hrs',
      prep: 'No special preparation needed.',
  ...
  static const List<BloodTest> packages = [
    BloodTest(
      ...
      price: 2999, mrp: 5294, fasting: true, sample: 'Blood + Urine', report: '24 hrs',
    ...
    BloodTest(
      ...
      price: 1499, mrp: 1948, fasting: true, sample: 'Blood', report: '24 hrs',
